...
print( 'Reading hindi vectors', flush = True);
...
print( 'Reading english vectors', flush = True);
...
# reading link data
print( 'Reading link data', flush = True);
...
print( 'Performing reverse cross validation without bias', flush = True);
print( 'Result = ', cross_validation( eng_dict[ pos], hin_dict[ pos], filtered_rlink_list, pos, bias_p = False));
print( 'Performing reverse cross validation with bias', flush = True);
print( 'Result = ', cross_validation( eng_dict[ pos], hin_dict[ pos], filtered_rlink_list, pos, bias_p = True));
